...
router.get("/categories", authMiddleware_1.authMiddleware, tenantMiddleware_1.tenantMiddleware, (0, asyncHandler_1.asyncHandler)(new ListCategoriesController_1.ListCategoriesController().handle));
router.post("/categories", authMiddleware_1.authMiddleware, tenantMiddleware_1.tenantMiddleware, (0, validateSchema_1.validateSchema)(categorySchema_1.createCategorySchema), (0, asyncHandler_1.asyncHandler)(new CreateCategoryController_1.CreateCategoryController().handle));
router.put("/categories/:id", authMiddleware_1.authMiddleware, tenantMiddleware_1.tenantMiddleware, (0, validateSchema_1.validateSchema)(categorySchema_1.updateCategorySchema), (0, asyncHandler_1.asyncHandler)(new UpdateCategoryController_1.UpdateCategoryController().handle));
router.delete("/categories/:id", authMiddleware_1.authMiddleware, tenantMiddleware_1.tenantMiddleware, (0, asyncHandler_1.asyncHandler)(new DeleteCategoryController_1.DeleteCategoryController().handle));
